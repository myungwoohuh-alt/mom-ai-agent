...
def show_history():
    ...
    add_message("미지의 동굴 탐사를 계속하다 보면\n"
    "어떤 도구들로 어떻게 사용하며 여기까지 왔는지 깜빡깜빡합니다.\n\n"
    "그래서 반드시 탐사 기록을 하며 계속 참고로 하세요.\n\n"
...
def show_second_door():
    ...
    add_message("저번 것보다 더 단단한\n"
    "이중으로 잠겨 있네요.\n\n"
    "이번에는 동글이 두가지 질문을 합니다.\n\n"
...
def show_second_result():
    ...
    "또한, 군대처럼 정해진 규칙에 따르는 것이 효율적이긴 하지만,\n"
